...
import com.example.skill54.R;
import com.example.skill54.adapter.MoviesAdapter;
import com.example.skill54.model.Movie;
import com.example.skill54.movie_details.MovieDetailsActivity;
...
public class MovieListActivity extends AppCompatActivity implements MovieListContract.View, MovieItemClickListener,ShowEmptyView {
    ...
    private String KEY_MOVIE_ID;
    private String KEY_RELEASE_TO;
